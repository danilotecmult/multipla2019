<?php
	...
	$mail->Username = 'formulario.grupomultipla@gmail.com'; //usu�rio do smtp (email cadastrado no servidor)
	$mail->Password = 'comunicacao102030'; //senha ****CUIDADO PARA N�O EXPOR ESSA INFORMA��O NA INTERNET OU NO F�RUM DE D�VIDAS DO CURSO****
	
	//dados de envio de e-mail
	$mail->addAddress('formulario.grupomultipla@gmail.com', 'Multipla'); //e-mails que receberam a mesagem
	...
	$mail->Body    = $messageEmail; //Se o formato da mensagem for HTML voc� poder� utilizar as tags do HTML no corpo do e-mail
